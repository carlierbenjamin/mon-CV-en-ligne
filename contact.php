<?php
  $array = array("firstname" => "", "lastname" => "", "email" => "", "phone" => "", "message" => "", "firstnameError" => "", "lastnameError" => "", "emailError" => "", "phoneError" => "", "messageError" => "", "isSuccess" => false);
  $emailTo = "benjamincarlier.svt@gmail.com";
  
  if ($_SERVER["REQUEST_METHOD"] == "POST") { 
    $array["firstname"] = test_input($_POST["firstname"]);
    $array["lastname"] = test_input($_POST["lastname"]);
    $array["email"] = test_input($_POST["email"]);
    $array["email"] = filter_var($array["email"], FILTER_SANITIZE_EMAIL);
